...
<form action="MarkComplaints.jsp">
    <input type="submit" value="Mark a complaint as Resolved" />
</form>
...
<div id = 'admin'>
<h4>ID of user whose complaint is resolved</h4>
<form action="MarkComplaintServlet" method="post">
			<table style="with: 50%">
