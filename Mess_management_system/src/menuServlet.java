...
public class menuServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.println("<th>Day</th><th>Breakfast</th><th>Lunch</th><th>Snacks</th><th>Dinner</th>");
			while(rs.next()) {
				String s1=rs.getString("breakfast");
				String s2=rs.getString("lunch");
				String s3=rs.getString("snacks");
				String s4=rs.getString("dinner");
				int i=rs.getInt("day");
					out.println("<tr>");
